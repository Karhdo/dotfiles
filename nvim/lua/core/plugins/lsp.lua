...
local M = {
    {
        ...
        dependencies = {
            ...
            "jose-elias-alvarez/typescript.nvim", "folke/neodev.nvim"
        },
        config = function()
        ...
        enabled = not vim.g.vscode,
        dependencies = {
            "williamboman/mason.nvim", "jayp0521/mason-null-ls.nvim"
        },
        config = function()
            ...
            require("mason-null-ls").setup({
                ensure_installed = {
                    "stylua", "hadolint", "prettierd", "stylelint",
            ...
            local function on_attach(client, bufnr)
                ...
                if not config.disable_rename and
            ...
            null_ls.setup({
                ...
                sources = {
                    ...
                    null_ls.builtins.formatting.prettierd.with({
                        filetypes = {
                            "css", "scss", "sass", "markdown", "svelte", "vue",
                            "yaml"
                        },
                        condition = function(utils)
                    ...
                    null_ls.builtins.formatting.prettierd.with({
                        filetypes = {
                            "css", "scss", "sass", "markdown", "yaml", "html",
