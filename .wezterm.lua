...
-- Wallpaper bundled in this repo's images/ dir (the repo lives at
-- ~/Workplace/Karhdo/dotfiles and is stowed into $HOME).
local wallpaper = wezterm.home_dir .. "/Workplace/Karhdo/dotfiles/images/wallpaper.jpg"
